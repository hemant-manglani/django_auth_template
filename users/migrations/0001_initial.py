# Generated by Django 5.0 on 2023-12-27 06:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("candidate_fname", models.CharField(max_length=100)),
                ("candidate_lname", models.CharField(max_length=100)),
                ("candidate_email", models.EmailField(max_length=254)),
                ("candidate_phone", models.IntegerField(blank=True)),
                ("profile_heading", models.CharField(max_length=1000)),
